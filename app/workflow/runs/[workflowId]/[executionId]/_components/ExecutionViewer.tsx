                ...
                {isRunning && (
                    <div className="flex items-center flex-col gap-2 justify-center h-full w-full">
                        <p className="font-bold">
                            Run us in progress, please wait...
                        </p>
                    </div>
                )}
                    ...
                    <div className="flex items-center flex-col gap-2 justify-center h-full w-full">
                        <div className="flex flex-col gap-1 text-center">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Please select a phase to view its details
                            </p>
                        </div>
                    </div>
                )}
            ...
            <CardContent className="py-4">
                <div className="flex flex-col gap-2">
                    ...
                    {params && Object.entries(params).map(([key, value]) => (
                        <div key={key} className="flex justify-center items-center space-y-1">
                        ...
                        {logs.map((log) => (
                            <TableRow key={log.id} className="text-muted-foreground">
                                ...
                                <TableCell width={80} className={cn(
                                    ...
                                    log.logLevel as LogLevel === "info" && "text-blue-600",
                                    log.logLevel as LogLevel === "warning" && "text-amber-500",
                                )}>
                                    {log.logLevel}
                                </TableCell>
